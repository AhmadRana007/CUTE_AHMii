...
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;94mFACEBOOK : AHMAD RANA

\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;91mGITHUB   :  MR AHMAD
...
\033[1;90m══════════════════════════════════════════════════
    """)
		...
		print("")
		print("\n    \033[0;92m            UID🔥 OLD IDZ CLONING 🔥 \033[0;97m ")
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [AHMAD] : %s/%s -> \033[0;92m [ BY-OK:%s ]- \033[0;91m[BY-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		print(" [*] Team      :  \n")
		print(" [ Sosial Medi  ] \n")
		print(" [*] Facebook  : https://facebook.com/mAHMAD ")
		print(" [*] Instagram : https://instagram.com/MR____AHMAD")
		print(" [*] YouTube   : https://youtube.com/AHMAD---RANA")
		exit(" [*] GitHub    : https://github.com/AHMAD")
	else:
		Main()
